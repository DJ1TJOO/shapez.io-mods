...
import { PipePinRendererComponent } from "../components/pipe_pin_renderer";

export class PipePinRendererSystem extends GameSystemWithFilter {
    constructor(root) {
        super(root, [PipePinRendererComponent]);

        this.pinSprite = Loader.getSprite("sprites/pipes/pin.png");
        this.pinConnectedSprite = Loader.getSprite("sprites/pipes/pin_connected.png");
    }
    ...
    drawChunk(parameters, chunk) {
        ...
        for (let i = 0; i < contents.length; ++i) {
            ...
            const renderComp = entity.components["PipePinRenderer"];
