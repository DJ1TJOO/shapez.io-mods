...
export class MetaEnergyConnectorBuilding extends ModMetaBuilding {
    constructor() {
        super("energy_connector");
    }
    ...
    getPreviewSprite(rotationVariant, variant) {
        switch (arrayConnectorRotationVariantToType[rotationVariant]) {
            case enumConnectorType.forward: {
                return Loader.getSprite("sprites/connectors/energy/" + "connector" + "_forward.png");
            }
            case enumConnectorType.turn: {
                return Loader.getSprite("sprites/connectors/energy/" + "connector" + "_turn.png");
            }
            case enumConnectorType.split: {
                return Loader.getSprite("sprites/connectors/energy/" + "connector" + "_split.png");
            }
            case enumConnectorType.cross: {
                return Loader.getSprite("sprites/connectors/energy/" + "connector" + "_cross.png");
            }
            case enumConnectorType.stub: {
                return Loader.getSprite("sprites/connectors/energy/" + "connector" + "_stub.png");
            }
            default: {
    ...
    setupEntityComponents(entity) {
        ...
        entity.addComponent(new EnergyConnectorRendererComponent());
    }
